...
\begin{description}
  ...
  \end{itemize}
\end{description}
Other incarnations of reversible flowcharts exist; Janus \cite{JAN} is a (structured) reversible programming language that can be said to have influenced RL and SRL considerably. This thesis will not discuss other reversible programming langauges any further.
