...
\begin{figure}[h]
  ...
  \begin{subfigure}{\textwidth}
    \lstinputlisting[language=haskell, firstline=154, lastline=163]{../src/src/Common/Interp.hs}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{\textwidth}
    \lstinputlisting[language=haskell, firstline=243, lastline=254]{../src/src/Common/Interp.hs}
    \caption{Partial implementation of binary operator expression evaluation.}\label{fig:exbinary}
  \end{subfigure}

  \begin{subfigure}{\textwidth}
    \lstinputlisting[language=haskell, firstline=275, lastline=280]{../src/src/Common/Interp.hs}
