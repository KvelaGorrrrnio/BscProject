...
\begin{figure}[h]
  ...
  \begin{subfigure}{\textwidth}
    \lstinputlisting[language=haskell, firstline=169, lastline=178]{../src/src/Common/Interp.hs}
...
\begin{figure}[H]
  \lstinputlisting[language=haskell, firstline=252, lastline=252]{../src/src/Common/Interp.hs}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{\textwidth}
    \lstinputlisting[language=haskell, firstline=258, lastline=269]{../src/src/Common/Interp.hs}
    \caption{Partial implementation of binary operator expression evaluation.}\label{fig:exbinary}
  \end{subfigure}

  \begin{subfigure}{\textwidth}
    \lstinputlisting[language=haskell, firstline=290, lastline=295]{../src/src/Common/Interp.hs}
...
\begin{figure}[h]
  \lstinputlisting[language=haskell, firstline=13, lastline=13]{../src/src/RL/Interp.hs}
