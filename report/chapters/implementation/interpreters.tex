...
\begin{figure}
  \lstinputlisting[language=haskell, firstline=21, lastline=21]{../src/src/RL/AST.hs}
  \caption{The representation of an RL block.}\label{fig:rlblock}
\end{figure}

\begin{figure}
  \lstinputlisting[language=haskell, firstline=17, lastline=17]{../src/src/RL/AST.hs}
  \caption{The abstract syntax tree for RL.}\label{fig:rlast}
\end{figure}

\begin{figure}
  \lstinputlisting[language=haskell, firstline=30, lastline=33]{../src/src/RL/AST.hs}
  \caption{The representation of come-from assertions.}\label{fig:from}
\end{figure}

\begin{figure}
  \lstinputlisting[language=haskell, firstline=39, lastline=42]{../src/src/RL/AST.hs}
